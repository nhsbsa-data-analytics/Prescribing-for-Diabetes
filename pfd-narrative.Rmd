...
::: 
:::{.col-md-6} 
`r infoBox_no_border(header = "", text = "<b>>In 2022/23 55% of identified patients were female.</b>", width = "100%")` 
:::
::::
...
::: 
:::{.col-md-6} 
`r infoBox_no_border(header = "", text = "<b>>In 2022/23 550,000 patients were from the most deprived areas in England.</b>", width = "100%")` 
:::
::::
...
The readings from interstitial fluid can lag behind blood sugar by up to 15 minutes so the use of does not entirely replace other diabetic monitoring such as testing strips though it would usually reduce the requirements for such. 
